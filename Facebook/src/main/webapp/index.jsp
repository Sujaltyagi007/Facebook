	  ...
	  <div class="row align-items-start">
	    <div class="col-3">
	      <div class="sidenav" id="sidenav">
	        <a href="#"><i><img src="Userimages/<%out.print(user.getUimg());%>" style="width:30px; border-radius:50%; height:30px; margin:-5px; "></i style="margin-left:2px;"><%out.print(user.getUname()); %></a>
