...
<section class="cover-image-section">		
			...
			<img src="Userimages/<%out.print(user1.getUproimage());%>">
	...
	<div class="profile-section-in">
		<div class="profile-image-site">
			<div class="profile-image-div">
				...
				<img id="Profile_images" src="Userimages/<%out.print(user1.getUimg());%>">
				</a>
...
<div class="profile-name-info">
	<h1>
	<span class="pro-txt" id="profile_name"><%out.print(user1.getUname()); %></span>
...
<div class="profile-button-site">
	<div class="btn-site-pro">
	<span>
    <a href="Frndrqstsend?uid=<%out.print(id);%>&uid1=<%out.print(id1);%>&actid=<%out.print(id);%>" style="color: white;
